...
const SLIDES = [
  ...
  },
  {
    ...
    subtitle: 'Set personalized calorie and macro targets. NutriLens gives you the insights to achieve the health you want.',
        ...
        <View style={styles.controls}>
          ...
          <View style={styles.buttons}>
            ...
            {currentIndex < SLIDES.length - 1 && (
              <Pressable onPress={() => router.push('/(auth)/setup')} style={styles.skipBtn}>
