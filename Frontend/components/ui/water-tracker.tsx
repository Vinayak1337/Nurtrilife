...
export function WaterTracker({
	...
	function handleCustomAdd() {
		...
		if (Number.isNaN(val) || val < 10 || val > 2000) {
			Alert.alert(
				'Invalid Amount',
				'Please enter a value between 10 and 2000 ml.'
			);
			return;
		}
		handleAdd(val);
							...
							<Pressable
								...
								style={[
									styles.addBtn,
									{
										...
										borderColor: `${Palette.protein}30`
									}
								]}>
						...
						{lastCustomMl != null && (
							<Pressable
								...
								style={[
									styles.addBtn,
									{
										backgroundColor: `${Palette.protein}20`,
										borderColor: `${Palette.protein}50`
									}
								]}>
								<AppText variant='caption' color={Palette.protein}>
									+{lastCustomMl}ml
						...
						<View style={styles.customRow}>
							<TextInput
								style={[
									...
									{
										color: theme.text,
										borderColor: `${Palette.protein}40`,
										backgroundColor: `${Palette.protein}08`
									}
								]}
								value={customInput}
							...
							<Pressable
								...
								style={[
									styles.addBtn,
									{
										backgroundColor: Palette.protein,
